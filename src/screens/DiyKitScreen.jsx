            ...
            <div className={styles.main}>
                ...
                <div className={styles.topContainer2}>
                    <div className={styles.topContainer}>
                        ...
                        <h6>Solar can be more expensive than a wall street hooker, therefore to reduce the cost we cut out the salesman and provide you with every component you need to provide your home with solar, every project is custom designed to fit your homes needs.</h6>
                ...
                <div className={styles.bottomContainer}>
                    <div className={styles.bottomWords}>
                        ALL DIY SOLAR KITS COME WITH LIFETIME SUPPORT, QUALITY COMPONENTS AT THE BEST PRICES
                    </div>
                </div>
                <div className={styles.kitsContainer}>KITS
